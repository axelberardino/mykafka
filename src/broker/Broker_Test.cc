...
// BOOST_FIXTURE_TEST_CASE(test_parallel_read_write, Setup)
// {
...
// BOOST_FIXTURE_TEST_CASE(test_many_parallel_add_partition, Setup)
// {
//   const std::string topic = "parallel_add_partition";
...
//   {
//     const int32_t from = ti * 200;
//     const int32_t to = from + 200;
//     threads.emplace_back(std::thread([&broker,from,to,topic]() {
...
{
  const std::string topic = "parallel_addpartition_readwrite";
  const int32_t partition = 0;
...
BOOST_FIXTURE_TEST_CASE(test_delete_topic_while_read_write, Setup)
{
